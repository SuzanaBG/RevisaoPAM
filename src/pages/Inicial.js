...
export default function Inicial({ navigation }) {
    const realizarLogin = () => {
        navigation.navigate('Login', { fromInicial: true })
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.container1}>
        <Image  source={casual} style={styles.img1} resizeMode="contain"></Image>
      ...
      <View style={styles.container2}>
        <Pressable style={styles.btt1}>
          <Image source={google} style={styles.img2} resizeMode="contain"></Image>
          <Text style={styles.text3}>Como deseja acessar?</Text>
        </Pressable>
        <Pressable style={styles.btt2} onPress={realizarLogin}>
